$(document).ready(function () {
  ...
  av.umsg("We will demonstrate the Binning hash function. To make the computation easy (because you can probably divide by 10 in your head easily) we will store records in an array of size 10.");
  av.displayInit();
